                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="page-forgot-password.php" method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="forgoten-account-email" class="form-control" placeholder="hello@example.com" required>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" name="forgoten-account-submit" class="btn btn-primary btn-block">SUBMIT</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
